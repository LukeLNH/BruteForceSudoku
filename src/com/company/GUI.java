...
//source: https://github.com/mtacchino/sudoku-solver/blob/master/src/me/tacchino/sudoku/GUI.java
    ...
    public class GUI {
        ...
        public void GUIToSudokuTable(){
            for (int y = 0; y < 9; y++){
                for (int x = 0; x < 9; x++){
                     if (!textField[x][y].getText().equals("")) {
                        sudokuSolver.insert(x, y, Integer.parseInt(textField[x][y].getText())); //if a number is in the textfield, put it in the sudoku table
        ...
        public void sudokuTableToGUI() {
            for (int y = 0; y < 9; y++) {
                for (int x = 0; x < 9; x++) {
                    ...
                    textField[x][y].setText(String.valueOf(sudokuSolver.getSolvedBoard()[x][y]));
